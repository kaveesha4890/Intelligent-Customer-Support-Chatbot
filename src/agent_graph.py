...
def route_chitchat(state: AgentState) -> str:
    """After chitchat check: if a canned reply was set, go to END; otherwise classify intent."""
...
def run_agent(user_message: str, history: list, session_id: str = "default") -> tuple:
